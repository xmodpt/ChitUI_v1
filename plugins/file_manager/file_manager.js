/**
 * File Manager Plugin - Frontend Logic
 *
 * Handles file upload, file list management, storage monitoring, and file operations
 */
...
(function() {
  ...
  function uploadFile() {
    ...
    var req = $.ajax({
      url: '/plugin/file_manager/upload',
      type: 'POST',
      data: formData,
      cache: false,
      contentType: false,
  ...
  function updateUsbGadgetStorage() {
    fetch('/plugin/file_manager/usb-gadget/storage')
